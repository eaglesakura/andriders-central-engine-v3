...
public class DbActivePluginDao extends AbstractDao<DbActivePlugin, String> {
    ...
    */
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, DbActivePlugin entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, DbActivePlugin entity) {
        stmt.clearBindings();
        stmt.bindString(1, entity.getUniqueId());
        stmt.bindString(2, entity.getCategory());
        stmt.bindString(3, entity.getPackageName());
    ...
    @Override
    protected final String updateKeyAfterInsert(DbActivePlugin entity, long rowId) {
