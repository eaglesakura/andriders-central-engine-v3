...
public class DbCycleDateLogDao extends AbstractDao<DbCycleDateLog, String> {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'DB_CYCLE_DATE_LOG' (" + //
                ...
                "'EXERCISE' REAL," + // 10: exercise
                "'SUM_ALTITUDE' REAL," + // 11: sumAltitude
                "'EXTRA_PAYLOAD' BLOB);"); // 12: extraPayload
        // Add Indexes
    ...
    public DbCycleDateLog readEntity(Cursor cursor, int offset) {
        DbCycleDateLog entity = new DbCycleDateLog( //
                ...
                cursor.isNull(offset + 9) ? null : cursor.getDouble(offset + 9), // calories
                cursor.isNull(offset + 10) ? null : cursor.getDouble(offset + 10), // exercise
                cursor.isNull(offset + 11) ? null : cursor.getDouble(offset + 11), // sumAltitude
                cursor.isNull(offset + 12) ? null : cursor.getBlob(offset + 12) // extraPayload
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, DbCycleDateLog entity, int offset) {
        ...
        entity.setCalories(cursor.isNull(offset + 9) ? null : cursor.getDouble(offset + 9));
        entity.setExercise(cursor.isNull(offset + 10) ? null : cursor.getDouble(offset + 10));
        entity.setSumAltitude(cursor.isNull(offset + 11) ? null : cursor.getDouble(offset + 11));
        entity.setExtraPayload(cursor.isNull(offset + 12) ? null : cursor.getBlob(offset + 12));
    }
