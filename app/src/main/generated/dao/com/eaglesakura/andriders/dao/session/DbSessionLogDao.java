...
public class DbSessionLogDao extends AbstractDao<DbSessionLog, String> {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'DB_SESSION_LOG' (" + //
                ...
                "'CALORIES' REAL," + // 10: calories
                "'EXERCISE' REAL," + // 11: exercise
                "'SUM_ALTITUDE' REAL," + // 12: sumAltitude
                "'EXTRA_PAYLOAD' BLOB);"); // 13: extraPayload
        // Add Indexes
    ...
    protected void bindValues(SQLiteStatement stmt, DbSessionLog entity) {
        ...
        if (calories != null) {
            stmt.bindDouble(11, calories);
        }

        Double exercise = entity.getExercise();
        if (exercise != null) {
            stmt.bindDouble(12, exercise);
        }

        Double sumAltitude = entity.getSumAltitude();
        if (sumAltitude != null) {
            stmt.bindDouble(13, sumAltitude);
        }

        byte[] extraPayload = entity.getExtraPayload();
        if (extraPayload != null) {
            stmt.bindBlob(14, extraPayload);
        }
    }
    ...
    public DbSessionLog readEntity(Cursor cursor, int offset) {
        DbSessionLog entity = new DbSessionLog( //
                ...
                cursor.isNull(offset + 10) ? null : cursor.getDouble(offset + 10), // calories
                cursor.isNull(offset + 11) ? null : cursor.getDouble(offset + 11), // exercise
                cursor.isNull(offset + 12) ? null : cursor.getDouble(offset + 12), // sumAltitude
                cursor.isNull(offset + 13) ? null : cursor.getBlob(offset + 13) // extraPayload
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, DbSessionLog entity, int offset) {
        ...
        entity.setCalories(cursor.isNull(offset + 10) ? null : cursor.getDouble(offset + 10));
        entity.setExercise(cursor.isNull(offset + 11) ? null : cursor.getDouble(offset + 11));
        entity.setSumAltitude(cursor.isNull(offset + 12) ? null : cursor.getDouble(offset + 12));
        entity.setExtraPayload(cursor.isNull(offset + 13) ? null : cursor.getBlob(offset + 13));
    }
